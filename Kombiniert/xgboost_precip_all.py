...
# -*- coding: utf-8 -*-
"""
Full Performance Analysis Pipeline v1.4 (Final Fix)
===================================================
"""
...
def get_all_precip_stations():
    ...
    for f in MASTER_DIR.glob("*_full_2020_2025_master.parquet"):
        try:
            ...
            # Use station_name if available, otherwise station
...
def build_neighbors(target_station, all_stations, n_neighbors=N_NEIGHBORS):
    ...
    for s in all_stations:
        ...
        neighbors.append({**s, "score": score})
    return sorted(neighbors, key=lambda x: x["score"])[:n_neighbors]
...
def cluster_stations(results_df, n_clusters=N_CLUSTERS):
...
def main():
    logger.info("=== FULL PERFORMANCE ANALYSIS PIPELINE v1.4 ===")
